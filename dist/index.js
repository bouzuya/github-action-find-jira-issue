...
exports.run = exports.setOutputs = exports.getInputs = exports.findJiraIssue = exports.extractIssueKeys = exports.getIssue = void 0;
const core = __importStar(__nccwpck_require__(186));
const http_client_1 = __nccwpck_require__(925);
// export for testing
function getIssue(config, issueKey) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const client = new http_client_1.HttpClient("find-jira-issue");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (issueKeys.length === 0) {
            ...
            for (const issueKey of issueKeys) {
                const issue = yield getIssue(config, issueKey);
                if (issue !== null) {
                    return issue;
                }
            }
...
exports.findJiraIssue = findJiraIssue;
// export for testing
function getInputs() {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            setOutputs(yield findJiraIssue(getInputs()));
        }
        catch (error) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const find_jira_issue_1 = __nccwpck_require__(915);
find_jira_issue_1.run();
